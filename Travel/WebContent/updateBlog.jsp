	...
	<div class="col-md-9">
		<div class="data_list">
			<div class="data_list_title">
				<h1 align="center">
					<span class="glyphicon glyphicon-cloud-upload"></span>&nbsp;修改日志
				</h1>
			</div>
					...
					<div class="row" style="padding-top: 20px;">
						...
						<div class="col-md-12">
							<form class="form-horizontal" method="post"
								action="blogServlet?actionName=updates" id="blogForm">
								<input type="hidden" name="blogId" value="${Blog.blogId }">
								<div class="form-group">
									<label for="title" class="col-sm-2 control-label">日志标题:</label>
									<div class="col-sm-8">
										<input class="form-control" name="title" id="title"
											placeholder="日志标题" value="${Blog.btitle }">
									</div>
								</div>
								<div class="form-group">
									<label for="title" class="col-sm-2 control-label">日志内容:</label>
									<div class="col-sm-8">
										<textarea id="noteContent" name="content">${Blog.btext }</textarea>
									</div>
								</div>
								<div class="form-group">
