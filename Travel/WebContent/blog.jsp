...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	     <h1 align="center"><font color='red'>日志园</font></h1> 
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">欢迎${user.uname }留下你的足迹!</h1>
          </div>
        </div>
      </div>
    </div>
...
<section class="ftco-section bg-light">
	...
	<c:if test="${!empty page.dataList }">
	<div>
		<h1 align="center"><a href="addBlog.jsp" ><span class="glyphicon glyphicon-pencil"></span>&nbsp;写日志</a></h1>
	</div>
	            ...
	            <div class="blog-entry align-self-stretch">
	              <div class="text">
	                ...
	                <div class="meta mb-3">
	                  ...
	                  <div>${user.uname }</div>
	                  <div><a href="blog-single.jsp" class="meta-chat"><span class="icon-chat" ></span> 评论数${item.contentNumber}</a></div>
	                </div>
	                <div>
